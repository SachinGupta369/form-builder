...
// const specificPage = () => Navigate(`/loginpages/login`)
  ...
  return (
    ...
    <div className='menu'>
        <div className="logo">
            <img src="/public/SVG.png" alt="/public/SVG.png" /> <p>FormBot</p>
        </div>
    ...
    <div className="chatbot_main">
        ...
        <div className="chatbot_top">
            <div className="chatbot_left">
                <img src="/public/vectorleft.png" alt="vectorleft.png" /> 
            </div>
            ...
            <div className="chatbot_right">
                <img src="/public/vectorright.png" alt="vectorright.png" /> 
            </div>
        </div>
        ...
        <div className="chatbot_down">
            ...
            <img src="/public/Figure.png" alt="figure.png" />
        </div>
    </div>
    {/* Chatbots end here */}
    ...
    <div className="schoolform">
        <div className="schoolform_top">
            <h1>Replace your old school forms <br />
                with <br />
            chatbots</h1>
            <p>Typebot is a better way to ask for information. It leads to an increase in customer satisfaction and retention and multiply by <br />
            3 <br /> your conversion rate compared to classical forms.</p>
        </div>
        <div className="schoolform_down">
            <div className="schoolform_down_left">
                {/* wronglogo div start here */}
                <div className="wronglogo_div">
                    <img src="/public/wronglogo.png" alt="wronglogo.png" />
                </div>
                {/* schoolform_ form start here */}
                <div className="schoolform_form">
                    <form>
                        <div className="name">
                             <label >Full name <sup><img src="/public/star.png" /></sup></label> <br />
                             <input type="text" placeholder='Full name' /> <br /> 
                        </div>
                        <div className="email">
                            <label >Email <sup><img src="/public/star.png" /></sup></label> <br />
                            <input type="email" placeholder='Email' /> <br /> 
                        </div>
                        <div className="schoolform_checkbox">
                             <label htmlFor='schoolform-1'>What services are you interested in? <sup><img src="/public/star.png" /></sup> </label> <br />
                             <input type="checkbox" name="schoolform-1" id="Website Dev" />
                             <label htmlFor='schoolform-2'>Website Dev</label> <br />
                             <input type="checkbox" name="schoolform-2" id="Content Marketing" /> 
                             <label htmlFor='schoolform-3'>Content Marketing</label> <br />
                             <input type="checkbox" name="schoolform-3" id="Social Media" />
                             <label htmlFor='schoolform-4'>Social Media</label><br />
                             <input type="checkbox" name="schoolform-4" id="UI/UX Design" /> 
                             <label htmlFor='schoolform-5'>UI/UX Design</label> <br />
                        </div>
                        <div className="comment">
                             <label > Additional information <sup><img src="/public/star.png" /></sup> </label> <br />
                             <textarea name="" id="" placeholder='Additional information'></textarea> <br />
                        </div>
            ...
            {/* tryitout and rightwingarrow png  */}
                <img className='tryitout_logo' src="/public/tryitout.png" alt="tryitout.png" />
                <img className='rightwingarrow zindex' src="/public/rightwingarrow.png" alt="rightwingarrow.png" />
                {/* rightlogo div start from here */}
                <div className="rightlogo_div">
                    <img src="/public/rightlogo.png" alt="rightlogo.png" />
                </div>
                {/* school form div start from here */}
            <div className="schoolform_img">
                <img src="/public/formimage.png" alt="formimage.png" />
            </div>
            </div>
        </div>
    </div>
    ...
    <div className="twoimage_div_main">
        ...
        <div className="twoimage_div_up">
            <div className="twoimage_div_up-left">
                <img src="/public/twoimageup.png" alt="twoimageup.png" />
            </div>
        ...
        <div className="twoimage_div_down">
            ...
            <img src="/public/twoimagedown.png" alt="twoimagedown.png" />
            </div>
        </div>
    </div>
    ...
    <div className="logobundle">
        <img src="/public/logobundle.png" alt="logobundle.png" />
    ...
    <div className="realtime">
        <div className="realtime_contain">
            ...
            <p>One of the main advantage of a chat application is that you collect the user's responses on each question. <br />
            <span>You won't lose any valuable data.</span></p>
        </div>
        <div className="realtime_image">
            <img src="/public/realtimeimage.png" alt="realtimeimage.png" />
        </div>
    </div>
    {/* Realtime end here */}
            ...
            <div className="features_top"> 
                <div className="features_div">
                    ...
                    <div className="features_div_contain">
                        ...
                        <p>Include data in your form URL to segment <br />
                  ...
                  <div className="features_div">
                    ...
                    <p>Customize everything with your own <br />
    ...
    <div className="brand_logo">
        <div className="brand_logo_main">
            ...
            <img src="/public/brandlogoimg.png" alt="brandlogoimg.png" />
        </div>
    </div>
    {/* brand-logo end here */}
    ...
    <div className="last_div">
        <div className="last_div_main">
            ...
            <div className="last_div_main_center">
                ...
                <p>No trial. Generous <span id='last_div_id'>free</span> plan.</p>
            </div>
    ...
    <div className="footer">
        <div className="footer_main">
            <div className="footer_1">
                <span id='made'>Made with ❤️ by </span><br />
                <p>@cuvette</p>
            </div>
            <div className="footer_2">
                <p>Status <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>Documentation <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>Roadmap <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>Pricing </p>
            </div>
            <div className="footer_3">
                <p>Discord <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>Github repository <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>Twitter <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>Lindkedln <span><img src="/public/squarearrow.png" alt="squarearrow.png" /></span></p>
                <p>OSS Friends</p>
            </div>
